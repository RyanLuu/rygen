 ...
 */
extern int mustach_file(const char *template, size_t length, const struct mustach_itf *itf,
 ...
 * a other negative value in case of error.
 */
extern int mustach_fd(const char *template, size_t length, const struct mustach_itf *itf,
 ...
 * a other negative value in case of error.
 */
extern int mustach_mem(const char *template, size_t length, const struct mustach_itf *itf,
